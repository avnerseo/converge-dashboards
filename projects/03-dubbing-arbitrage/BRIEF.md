...
## First task — an honest test, not a build

1. Pick three candidate tools and read their **actual current pricing pages**,
   not summaries of them. Confirm or refute per-source-minute billing. Record
   what you find with links and dates.
2. Run one real Hebrew source clip (60–90s) through the two most promising tools
   into English and one other language.
3. Judge honestly: is the Hebrew source transcribed correctly? Does the output
   sound like a person? Do financial terms and numbers survive? Is the timing
   still aligned?
4. Record measured cost per finished minute against the claimed rate.
